1.Open the box and switch on the router by connecting the cable to laptop and search the wifi signal with SSID which is displayed on the backside of the router.
